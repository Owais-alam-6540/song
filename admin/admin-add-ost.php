...
if(isset($_POST['btn'])){
   ...
   $query1="SELECT * FROM `ost` where `Name`= '{$ost}'";
   ...
   $query = "INSERT INTO `ost` (`Name`, `ost`, `Genre`, `Artist`, `Drama`, `Release_date`, `Writer`, `thumbnail`)
    VALUES ('$ost', '$ost_fname', '$genre', '$artistname', '$drama', '$releasedate', '$writer', '$ost_thumb')";
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Add ost</h4>
                        </div>
                     </div>
                        ...
                        <form  method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="custom-file">
                                 <input type="text" class="form-control" placeholder="Ost name"  name="ostname" required>
                              </div>
                           </div>
                           <div class="form-group">
                              <label>OST-Thumbnail:</label>
                              <div class="custom-file">
                                 <input type="file" class="custom-file-input" id="customFile" name="ost_thumb" required>
                           ...
                           <div class="form-group">
                              <label>OST:</label>
                              <div class="custom-file">
                                 <input type="file" class="custom-file-input" id="customFile" name="ost" required>
                                 <label class="custom-file-label" for="customFile">Choose file</label>
                              </div>
                           </div>
                           <div class="form-group">
                              <label>Writer:</label>
                              <div class="custom-file">
                                 <input type="text" class="form-control" placeholder="Writer"  name="writer" required>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <label>Drama:</label>
                              <input type="text" class="form-control" name="drama" placeholder="Drama name">
                           </div>
                           <div class="form-group">
                              <label>Genre:</label>
                              <select class="form-control" id="exampleFormControlSelect1" name="genre" required>
                                 <option selected="" disabled="">Ost Genre</option>
                                 <?php 

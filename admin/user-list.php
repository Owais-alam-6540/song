                        ...
                        <div class="table-responsive">
                           ...
                           while($row = mysqli_fetch_array($result)){
                              ...
                              <tr>
                                    ...
                                    <td><?php $status = ($row['status'] == '1')? 'Active': 'Disable'; echo $status;?></td>
                                  
                                    <td>
                                       <div class="d-flex align-items-center list-user-action">

                                          <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="deleteuserlist.php?id=<?php echo $row['User_id']?>"><i class="ri-delete-bin-line"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                          <?php }?> 

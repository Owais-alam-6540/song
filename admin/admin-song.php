                        ...
                        <div class="table-responsive">
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              ...
                              <tbody>
                                 ...
                                 $query ="SELECT * FROM `song` INNER JOIN `artist` ON `artist` = `Artist_Id` INNER JOIN `language` ON `language` = `Lang_Id`
                                 ...
                                 <tr>
                                    ...
                                    <td><img class="img-fluid avatar-60 rounded" src="../thumbnails/<?php echo $row ['thumbnail']?>" alt=""></td>
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="edit-song.php?id=<?php echo $row['Song_Id']?>"><i class="ri-pencil-line"></i></a>
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="delete-song.php?id=<?php echo $row['Song_Id']?>"><i class="ri-delete-bin-line"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php }?>

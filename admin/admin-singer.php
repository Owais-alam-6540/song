                     ...
                     <div class="iq-card-body">
                        <div class="table-responsive">
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              <thead>
                                 <tr>
                                    <th style="width: 12%;">Singer Name</th>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <img src="../web/img/artistimg/<?php echo $row ['Img']?>" class="img-fluid avatar-50 rounded" alt="author-profile">
                                    </td>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="edit-singer.php?id=<?php echo $row['Artist_Id']?>"><i class="ri-pencil-line"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php }?>

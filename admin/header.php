               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  <li class="active active-menu">
                     ...
                     <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="admin-r-rating.php"><i class="las la-headphones"></i>Review-Ratting</a></li>
                        <li><a href="admin-ost-rating.php"><i class="las la-headphones"></i>ost-Review-Ratting</a></li>
                        <li><a href="songs.php"><i class="lar la-file-audio"></i>All-Song</a></li>
                     </ul>
                  </li>
                  <li>
                     ...
                     <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="admin-albums.php"><i class="ri-function-line"></i>Albums</a></li>
                        <li><a href="admin-singer.php"><i class="las la-microphone-alt"></i>Singers</a></li>
                        <li><a href="admin-song.php"><i class="las la-play-circle"></i>Songs</a></li>
                        <li><a href="admin-ost.php"><i class="las la-play-circle"></i>OST</a></li>
                     </ul>
                  </li>
                  <li>
                     ...
                     <ul id="ui-elements" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li>
                           ...
                           <ul id="charts" class="iq-submenu collapse" data-parent="#ui-elements">
                              <li><a href="chart-morris.php"><i class="ri-file-chart-line"></i>Morris Chart</a></li>
                              <li><a href="chart-high.php"><i class="ri-bar-chart-line"></i>High Charts</a></li>
                              <li><a href="chart-am.php"><i class="ri-folder-chart-line"></i>Am Charts</a></li>
                              <li><a href="chart-apex.php"><i class="ri-folder-chart-2-line"></i>Apex Chart</a></li>
                           </ul>
                        </li>
                        <li>
                  ...
                  <li>
                     <a href="#pages" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="las la-file-alt iq-arrow-left"></i><span>Accounts</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="pages" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li>
                           ...
                           <ul id="extra-pages" class="iq-submenu collapse" data-parent="#pages">
                              ...
                              <li><a href="pages-pricing.php"><i class="ri-price-tag-line"></i>Pricing</a></li>
                  ...
                  <li>
                     <a href="logout.php" ><i class="ri-record-circle-line iq-arrow-left"></i>Logout Account</a>
                     <!-- <a href="logout.php" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-record-circle-line iq-arrow-left"></i><span>Logout account</span></a> -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="list-unstyled iq-menu-top d-flex justify-content-between mb-0 p-0">
                     ...
                     <li><a href="songs.php">All-Song</a></li>
                  </ul>
